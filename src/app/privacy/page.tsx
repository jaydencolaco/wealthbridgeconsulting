...
export default function PrivacyPage() {
  return (
    <div>
      <Navbar />
      <div className="p-10">
        <h1 className="font-extrabold text-4xl py-3 px-25">
          Privacy Policy for WealthBridge Consulting
        </h1>
        <div>
          <p className="font-light pb-2 px-25">Last updated: August 05, 2025</p>
          <p className="max-w-6xl px-25 pb-4">
          ...
          <hr />
          <h1 className="font-extrabold text-3xl py-3 px-25">
            Interpretation and Definitions
          </h1>
          <h3 className="text-xl font-semibold px-25">Interpretation</h3>
          <p className="max-w-6xl px-25 pb-4">
          ...
          <div className="max-w-6xl">
            <h3 className="text-xl font-semibold px-25">Definitions</h3>
            <p className="px-25">For the purposes of this Privacy Policy:</p>
            <ul className="list-disc px-35">
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Wealth Bridge
              ...
              <li>
                <p>
                  <strong>Website </strong>refers to Wealth Bridge Consulting,
                  accessible from{" "}
                  <a
                    href="https://www.thewealthbridgeconsulting.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 underline"
                  >
                    Visit Wealth Bridge Consulting
                  </a>
                </p>
              </li>
              <li>
          ...
          <div className="">
            ...
            <h3 className="text-xl font-bold px-25 pb-2">
              Types of Data Collected
            </h3>
            <h3 className="text-lg font-semibold px-25">Personal Data </h3>
            <p className="pt-4 px-25 max-w-6xl">
            ...
            <div className="px-25 max-w-6xl">
              ...
              <p>If you have any questions about this Privacy Policy, You can contact us by email: info@wealthbridgefzco.net</p>
            </div>
          </div>
        </div>
      </div>
